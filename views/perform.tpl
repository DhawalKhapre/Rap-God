...
<a id="startBut" class="button button-primary" onclick="play_song();" style="position:relative; top:-25em; text-align:center;  margin-left:auto; margin-top:20%; margin-right:auto; display: block; width:50%; background-color: white;color:black;text-decoration: none;   text-align: center; border-radius: 2px; border-color:#194350; height:50px; font-size: 20px"
    href="#">🔥 Done! Smash this button when u ready 🔥</a>


<h4 id="header" style="position:relative; top:-8em; margin-top: 4%; text-align: center; color: white; font-size: 50px; display: none">{{title}}
    Rap</h4>
<div class="container" id="content" style="position:relative; top:-26em;" >
...
<button id="again" class="button button-primary" onclick="play_song();" style="position:relative; top:-25em; display: none; margin-left:auto; margin-top:10%; margin-right:auto; width:50%; background-color:white; border-color: white; height:50px; font-size: 20px; color: black;">🔥
    Damn, son. Play dat again 🔥</button>
    <a id="download" download="{{title}}.mp3" href='../productions/{{title}}.mp3' class="button button-primary" style="position:relative; top:-25em; text-align:center; display: none; margin-top:2%; margin-left:auto; margin-right:auto; width:50%; background-color: white; border-color: white; height:50px; font-size: 20px;color:black;">🥁 Download rap as .mp3 🥁</a>

<a id="leave" href="/" class="button button-primary" style="position:relative; top:-25em; text-align:center; display: none; margin-left:auto; margin-top:2%; margin-right:auto; width:50%; background-color: white; border-color: white; height:50px; font-size: 20px; color: black;">🏃 Take
